...
<img src="profile.jpg" style="float: right; width: 220px; margin-left: 25px; margin-bottom: 10px; border-radius: 8px;">
...
<div style="margin-top: 10px; margin-bottom: 20px; line-height: 1.6;">
  ...
  <i class="fa-brands fa-github" style="width: 20px; text-align: center; margin-right: 5px;"></i> <a href="https://github.com/anmol-goyal7">GitHub</a><br>
  <i class="fa-brands fa-linkedin" style="width: 20px; text-align: center; margin-right: 5px;"></i> <a href="https://www.linkedin.com/in/anmol-goyal-92b460378/">LinkedIn</a><br>
